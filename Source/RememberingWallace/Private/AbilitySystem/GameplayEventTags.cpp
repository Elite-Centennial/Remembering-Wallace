...
DEFINE_GAMEPLAY_TAG(GTag_Event_Combat_Damaged, "Event.Combat.Damaged", TEXT("Unit is damaged"));
DEFINE_GAMEPLAY_TAG(GTag_Event_Combat_DidDamage, "Event.Combat.DidDamage", TEXT("Unit applied a damage"));
